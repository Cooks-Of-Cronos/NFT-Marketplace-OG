...
useEffect(() => {
  ...
  return (
    <div className="nft-collection">
      <h1 className="nft-collection__title">NFT Collection</h1>
      <div className="nft-collection__buttons">
        <button className="nft-collection__button" onClick={() => dispatch(connect())}>
          CONNECT
        </button>
        <button className="nft-collection__button" onClick={getAllNFTs}>
          Get All NFTs
        </button>
        <button className="nft-collection__button">
      ...
      <div className="nft-collection__grid">
        {Nfts.map((nft, index) => (
          <div key={index} className="nft-card">
            <img className="nft-card__image" src={nft.image} alt={nft.metadata.name} />
            <h3 className="nft-card__title">{nft.metadata.name}</h3>
            <p className="nft-card__description">{nft.metadata.description}</p>
            <p className="nft-card__token-id">Token ID: {nft.tokenId}</p>
          </div>
        ))}
      </div>
    </div>

												...
												{claimingNft ? "BUSY" : "MINT LIVE NOW"}
													...
													<div className="stkid-container">
														...
														<Modal isOpen={modalIsOpen} onRequestClose={() => setModalIsOpen(false)}>
															<blockquote className="reward" style={{
																color: "white",
																background: "black",
																padding: "1rem",
																borderRadius: "5px",
																...
																<span>Crooks In Jail(Staked)</span>
																{' '}
																{CurrentSInfo}
																{' '}$CROOKS
															</blockquote>
													...
													<div><div className="input-container">
														...
														/>
														<label htmlFor="claimid" className="cool-label" style={{ marginTop: "100px" }}>Claim ID</label>
													</div>
														<br></br>
														<button class="button" style={{ marginBottom: "20px" }} onClick={claimit}>CLAIM REWARDS</button>&nbsp;&nbsp;
